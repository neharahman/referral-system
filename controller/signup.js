        ...
        if(refCode){
            ...
            if(refCode_exits){
                ...
                if(refCode_exits['myInvites']){
                    refCode_exits['myInvites'].push({userName:refCode_exits.name,userId:refCode_exits.id,amount:50})
                }
                else{
                    refCode_exits['myInvites']={userName:refCode_exits.name,userId:refCode_exits.id,amount:50}
                }
